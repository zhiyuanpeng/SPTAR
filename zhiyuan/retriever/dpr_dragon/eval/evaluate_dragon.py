...
model = DRES(models.DPR((query_model_name, doc_model_name), query_state_dict=query_state_dict, doc_state_dict=doc_state_dict), batch_size=256, corpus_chunk_size=30000)
